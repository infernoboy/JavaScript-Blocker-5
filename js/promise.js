...
(function () {
	...
	window.CustomPromise = function CustomPromise (fn) {
		return attachCustomPromiseHandlers(new Promise(fn), fn);
	};
	...
	CustomPromise.all = function (promises) {
		return attachCustomPromiseHandlers(Promise.all(promises), promises);
	};

	CustomPromise.race = function (promises) {
		return attachCustomPromiseHandlers(Promise.race(promises), promises);
	};
})();
